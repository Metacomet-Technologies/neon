...
test('license scopes work correctly', function () {
    $user = User::factory()->create();
    License::factory()->active()->forUser($user)->count(2)->create();
    License::factory()->parked()->forUser($user)->count(3)->create();
    License::factory()->subscription()->forUser($user)->count(1)->create();
    License::factory()->lifetime()->forUser($user)->count(1)->create();

    expect($user->activeLicenses()->count())->toBe(2);
    expect($user->parkedLicenses()->count())->toBe(3);
    expect(License::subscription()->count())->toBe(3);
    expect(License::lifetime()->count())->toBe(3);
});
