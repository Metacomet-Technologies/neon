...
<head>
    ...
    <style>
        @media (max-width: 620px) {
            ...
            table.pc-w620-spacing-0-0-50-0 {
                margin: 0px 0px 50px 0px !important;
            }

            td.pc-w620-spacing-0-0-50-0,
            th.pc-w620-spacing-0-0-50-0 {
                margin: 0 !important;
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td valign="top"
                                                                ...
                                                                style="padding: 40px 40px 40px 40px; height: unset; border-radius: 0px; background-color: #1B1B1B;"
                                                                bgcolor="#1B1B1B">
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" align="center">
                                                                                        <div class="pc-font-alt"
                                                                                            ...
                                                                                            <div
                                                                                                style="font-size: 30px;line-height: 81%;text-align:center;text-align-last:center;color:#53eafd;letter-spacing:-0.6px;font-weight:400;font-style:normal;font-variant-ligatures:normal;">
                                                                                                <div><span
                                                                                                        style="font-family: 'Gugi', Arial, Helvetica, sans-serif; font-size: 36px; line-height: 81%; text-decoration: none; text-transform: none;"
                                                                                                        class="pc-w620-font-size-30px pc-w620-line-height-133pc">Neon</span>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" align="center">
                                                                                        <div class="pc-font-alt"
                                                                                            style="text-decoration: none;">
                                                                                            <div
                                                                                                style="font-size: 16px;line-height: 156%;text-align:center;text-align-last:center;color:#ffffff;letter-spacing:-0.2px;font-weight:300;font-style:normal;font-variant-ligatures:normal;">
                                                                                                <div><span
                                                                                                        style="font-family: 'Figtree', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 156%; text-decoration: none; text-transform: none;"
                                                                                                        class="pc-w620-font-size-16px pc-w620-line-height-163pc">Welcome
                                                                                                        to Neon. The
                                                                                                        world's best
                                                                                                        Discord
                                                                                                        Bot.</span>
                                                        ...
                                                        <tr>
                                                            <td valign="top"
                                                                ...
                                                                <table width="100%" border="0" cellpadding="0"
                                                                    cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td class="pc-w620-spacing-0-0-50-0"
                                                                            style="padding: 0px 0px 69px 0px;">
                                                                            <table
                                                                                ...
                                                                                <tr
                                                                                    ...
                                                                                    <td class="pc-grid-td-first pc-w620-itemsSpacings-40-40"
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td valign="top"
                                                                                                                            ...
                                                                                                                            <div class="pc-font-alt pc-w620-align-center"
                                                                                                                                style="text-decoration: none;">
                                                                                                                                <div
                                                                                                                                    style="font-size: 14px;line-height: 143%;text-align:left;text-align-last:left;color:#d8d8d8;letter-spacing:-0.2px;font-weight:400;font-style:normal;font-variant-ligatures:normal;">
                                                                                                                                    <div>
                                                                                                                                        <a href="{{ route('home') }}"
                                                                                                                                            class="pc-font-alt"
                                                                                                                                            style="line-height: 143%; letter-spacing: -0.2px; font-family: 'Figtree', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 500; font-variant-ligatures: normal; color: #1595e7; text-align: left; text-align-last: left;">{{ route('home') }}</a>
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </td>
                                                                                    ...
                                                                                    <td class="pc-grid-td-last pc-w620-itemsSpacings-40-40"
                                                                                        align="left" valign="top"
                                                                                                                                        ...
                                                                                                                                        <table
                                                                                                                                            ...
                                                                                                                                            <tr
                                                                                                                                                ...
                                                                                                                                                <td class="pc-grid-td-first pc-grid-td-last pc-w620-itemsSpacings-10-0"
                                                                                                                                                    valign="middle"
                                                                                                                                                    style="width: 33.333333333333%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;">
                                                                                                                                                    <table
                                                                                                                                                        style="border-collapse: separate; border-spacing: 0;"
                                                                                                                                                        border="0"
                                                                                                                                                        cellpadding="0"
                                                                                                                                                                            ...
                                                                                                                                                                            <table
                                                                                                                                                                                ...
                                                                                                                                                                                <tr>
                                                                                                                                                                                    <td
                                                                                                                                                                                        valign="top">
                                                                                                                                                                                        <a
                                                                                                                                                                                            href="https://x.com/metacomet_tech">
                                                                                                            ...
                                                                                                            <td align="center"
                                                                                                                ...
                                                                                                                <table
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td valign="top"
                                                                                                                            align="left">
                                                                                                                            <a href="{{ route('unsubscribe.update', ['email' => $email]) }}"
                                                                                                                                class="pc-font-alt"
                                                                                                                                style="line-height: 143%; letter-spacing: -0.2px; font-family: 'Figtree', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 500; font-variant-ligatures: normal; color: #1595e7; text-align: left; text-align-last: left;">
                                                                                                                                Unsubscribe</a>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </table>
